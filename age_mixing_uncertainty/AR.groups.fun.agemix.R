...
AR.groups.fun.agemix <- function(simpact.trans.net = simpact.trans.net,
  ...
  for(i in 1:seeds.id){
    ...
    transm.age.i.Rec <- as.data.frame(simpact.trans.net[[i]])
    
    age.i.Rec <- transm.age.i.Rec$InfecTime - transm.age.i.Rec$TOBRec
    age.i.Don <- transm.age.i.Don$InfecTime - transm.age.i.Rec$TOBDon
    
    transm.age.i <- cbind(transm.age.i.Rec, age.i.Rec.Rec, age.i.Don)
  ...
  if(length(IDs.transm)>=1){
    ...
    trans.sum.age.limit <- dplyr::filter(trans.sum.rename.id, trans.sum.rename.id$age.i.Rec<=age.group.40.50[2])
    ...
    trans.sum.men.15.25 <- dplyr::filter(trans.sum.age.limit, trans.sum.age.limit$GenderRec=="0" & trans.sum.age.limit$age.i.Rec >= age.group.15.25[1] & trans.sum.age.limit$age.i.Rec < age.group.15.25[2])
    
    trans.sum.women.15.25 <- dplyr::filter(trans.sum.age.limit, trans.sum.age.limit$GenderRec=="1" & trans.sum.age.limit$age.i.Rec >= age.group.15.25[1] & trans.sum.age.limit$age.i.Rec < age.group.15.25[2])
    ...
    trans.sum.men.25.40 <- dplyr::filter(trans.sum.age.limit, trans.sum.age.limit$GenderRec=="0" & trans.sum.age.limit$age.i.Rec >= age.group.25.40[1] & trans.sum.age.limit$age.i.Rec < age.group.25.40[2])
    
    trans.sum.women.25.40 <- dplyr::filter(trans.sum.age.limit, trans.sum.age.limit$GenderRec=="1" & trans.sum.age.limit$age.i.Rec >= age.group.25.40[1] & trans.sum.age.limit$age.i.Rec < age.group.25.40[2])
    ...
    trans.sum.men.40.50 <- dplyr::filter(trans.sum.age.limit, trans.sum.age.limit$GenderRec=="0" & trans.sum.age.limit$age.i.Rec >= age.group.40.50[1] & trans.sum.age.limit$age.i.Rec < age.group.40.50[2])
    
    trans.sum.women.40.50 <- dplyr::filter(trans.sum.age.limit, trans.sum.age.limit$GenderRec=="1" & trans.sum.age.limit$age.i.Rec >= age.group.40.50[1] & trans.sum.age.limit$age.i.Rec < age.group.40.50[2])
