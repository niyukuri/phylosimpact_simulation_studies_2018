...
classic.features.scenarios.CAR <- function(datalist = datalist.agemix,
                                           work.dir = work.dir,
  ...
  IDs.study <- IDs.Seq.Random(simpact.trans.net = simpact.trans.net, 
...
# xy <- classic.features.scenarios.CAR(datalist = datalist.agemix,
#                                     work.dir = work.dir,
#                                     sub.dir.rename = sub.dir.rename,
#                                     time.window = c(10,30),
#                                     seq.cov = 100,
