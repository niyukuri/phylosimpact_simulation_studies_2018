...
LMEM.master.model.age.mixing.toy1 <- function(inputvector = input.vector){
  ...
  name.clust.MCAR.35 <- paste0("clust.MCAR.35.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.40 <- paste0("clust.MCAR.40.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.45 <- paste0("clust.MCAR.45.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.50 <- paste0("clust.MCAR.50.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.55 <- paste0("clust.MCAR.55.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.60 <- paste0("clust.MCAR.60.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.65 <- paste0("clust.MCAR.65.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.70 <- paste0("clust.MCAR.70.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.75 <- paste0("clust.MCAR.75.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.80 <- paste0("clust.MCAR.80.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.85 <- paste0("clust.MCAR.85.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.90 <- paste0("clust.MCAR.90.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.MCAR.95 <- paste0("clust.MCAR.95.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  
  
  name.clust.MCAR.100 <- paste0("clust.MCAR.100.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var"))
  ...
  name.clust.AR.a.35 <- paste0("clust.AR.a.35.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.40 <- paste0("clust.AR.a.40.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.45 <- paste0("clust.AR.a.45.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.50 <- paste0("clust.AR.a.50.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.55 <- paste0("clust.AR.a.55.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.60 <- paste0("clust.AR.a.60.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.65 <- paste0("clust.AR.a.65.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.70 <- paste0("clust.AR.a.70.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.75 <- paste0("clust.AR.a.75.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.80 <- paste0("clust.AR.a.80.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.85 <- paste0("clust.AR.a.85.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.90 <- paste0("clust.AR.a.90.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.a.95 <- paste0("clust.AR.a.95.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  ...
  name.clust.AR.b.35 <- paste0("clust.AR.b.35.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.40 <- paste0("clust.AR.b.40.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.45 <- paste0("clust.AR.b.45.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.50 <- paste0("clust.AR.b.50.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.55 <- paste0("clust.AR.b.55.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.60 <- paste0("clust.AR.b.60.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.65 <- paste0("clust.AR.b.65.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.70 <- paste0("clust.AR.b.70.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.75 <- paste0("clust.AR.b.75.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.80 <- paste0("clust.AR.b.80.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.85 <- paste0("clust.AR.b.85.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.90 <- paste0("clust.AR.b.90.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.b.95 <- paste0("clust.AR.b.95.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  ...
  name.clust.AR.c.35 <- paste0("clust.AR.c.35.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.40 <- paste0("clust.AR.c.40.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.45 <- paste0("clust.AR.c.45.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.50 <- paste0("clust.AR.c.50.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.55 <- paste0("clust.AR.c.55.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.60 <- paste0("clust.AR.c.60.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.65 <- paste0("clust.AR.c.65.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.70 <- paste0("clust.AR.c.70.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.75 <- paste0("clust.AR.c.75.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.80 <- paste0("clust.AR.c.80.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.85 <- paste0("clust.AR.c.85.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.90 <- paste0("clust.AR.c.90.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  name.clust.AR.c.95 <- paste0("clust.AR.c.95.",c("av.age.male", "gendEffect.clust", "between.clust.var", "within.clust.var", "Num.Clusters", "av.Clust.Size"))
  ...
  name.true.transm.MCAR.35 <- paste0("true.transm.MCAR.35.",c("num.men.15.25", "num.women.15.25", "num.men.25.40", "num.women.25.40", "num.men.40.50", 
                                                              ...
                                                              "RT.slope.male", "RT.WSD.male", "RT.BSD.male", "RT.intercept.male", "T.av.age.male",
                                                              "T.gendEffect", "T.between.indiv.var", "T.within.indiv.var" ))
