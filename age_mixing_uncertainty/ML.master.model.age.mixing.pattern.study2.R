...
ML.master.model.age.mixing.pattern.study2 <- function(inputvector = input.vector){
  ...
  # Classic features and data msissingness 
  ##########################################
  ...
  #############################
  AD.tra <- abs(abs(agemixing.df.IDs$TOBDon) - abs(agemixing.df.IDs$TOBRec))
  mean.AD.tra <- mean(AD.tra)
  med.AD.tra <- median(AD.tra)
  sd.AD.tra <- sd(AD.tra)
  ...
  outputvector <- c(flag.women, flag.men, mean.AD.tra, med.AD.tra, sd.AD.tra, lme.val, flag.lme,
                    
                    ML.MCAR.cov.35, ML.MCAR.cov.40, ML.MCAR.cov.45, ML.MCAR.cov.50,
                    ML.MCAR.cov.55, ML.MCAR.cov.60, ML.MCAR.cov.65, ML.MCAR.cov.70,
                    ML.MCAR.cov.75, ML.MCAR.cov.80, ML.MCAR.cov.85, ML.MCAR.cov.90,
                    ML.MCAR.cov.95,
                    
                    ML.AR.a.cov.35, ML.AR.a.cov.40, ML.AR.a.cov.45, ML.AR.a.cov.50, ML.AR.a.cov.55,
                    ML.AR.a.cov.60, ML.AR.a.cov.65, ML.AR.a.cov.70, ML.AR.a.cov.75, ML.AR.a.cov.80,
                    ML.AR.a.cov.85, ML.AR.a.cov.90, ML.AR.a.cov.95,
                    
                    ML.AR.b.cov.35, ML.AR.b.cov.40, ML.AR.b.cov.45, ML.AR.b.cov.50, ML.AR.b.cov.55,
                    ML.AR.b.cov.60, ML.AR.b.cov.65, ML.AR.b.cov.70, ML.AR.b.cov.75, ML.AR.b.cov.80,
                    ML.AR.b.cov.85, ML.AR.b.cov.90, ML.AR.b.cov.95,
                    
                    ML.AR.c.cov.35, ML.AR.c.cov.40, ML.AR.c.cov.45, ML.AR.c.cov.50, ML.AR.c.cov.55,
                    ML.AR.c.cov.60, ML.AR.c.cov.65, ML.AR.c.cov.70, ML.AR.c.cov.75, ML.AR.c.cov.80,
                    ML.AR.c.cov.85, ML.AR.c.cov.90, ML.AR.c.cov.95)
