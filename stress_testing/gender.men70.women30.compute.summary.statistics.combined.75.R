...
gender.men70.women30.compute.summary.statistics.combined.75 <- function(datalist = datalist.agemix,
                                                                        work.dir = work.dir,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.75.IDs.gender.men70.women30)>=cut.val){
      ...
      cov.75.IDs.gender.men70.women30.features <- as.numeric(cov.75.IDs.gender.men70.women30.features)
      ...
      cov.75.IDs.gender.men70.women30.features <- c(cov.75.IDs.gender.men70.women30.features, 
                                                    cov.75.gender.men70.women30.ratio.seq,
                                                    cov.75.gender.men70.women30.ratio.emp)
      
      # cov.75.gender.men70.women30
    }else{
      cov.75.IDs.gender.men70.women30.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.75.IDs.gender.men70.women30.features)
