...
gender.men70.women30.compute.summary.statistics.combined.55 <- function(datalist = datalist.agemix,
                                                                        work.dir = work.dir,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.55.IDs.gender.men70.women30)>=cut.val){
      ...
      cov.55.IDs.gender.men70.women30.features <- as.numeric(cov.55.IDs.gender.men70.women30.features)
      ...
      cov.55.IDs.gender.men70.women30.features <- c(cov.55.IDs.gender.men70.women30.features, 
                                                    cov.55.gender.men70.women30.ratio.seq,
                                                    cov.55.gender.men70.women30.ratio.emp)
      
      # cov.55.gender.men70.women30
    }else{
      cov.55.IDs.gender.men70.women30.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.55.IDs.gender.men70.women30.features)
