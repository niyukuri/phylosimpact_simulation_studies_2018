...
gender.men30.women70.compute.summary.statistics.combined.65 <- function(datalist = datalist.agemix,
                                                                        work.dir = work.dir,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.65.IDs.gender.men30.women70)>=cut.val){
      ...
      cov.65.IDs.gender.men30.women70.features <- as.numeric(cov.65.IDs.gender.men30.women70.features)
      ...
      cov.65.IDs.gender.men30.women70.features <- c(cov.65.IDs.gender.men30.women70.features, 
                                                    cov.65.gender.men30.women70.ratio.seq,
                                                    cov.65.gender.men30.women70.ratio.emp)
      
      # cov.65.gender.men30.women70
    }else{
      cov.65.IDs.gender.men30.women70.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.65.IDs.gender.men30.women70.features)
