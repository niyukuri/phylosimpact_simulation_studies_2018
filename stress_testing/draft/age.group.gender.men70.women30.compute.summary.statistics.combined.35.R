...
gender.men70.women30.compute.summary.statistics.combined.35 <- function(datalist = datalist.agemix,
                                                                        work.dir = work.dir,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.35.IDs.gender.men70.women30)>=cut.val){
      ...
      cov.35.IDs.gender.men70.women30.features <- as.numeric(cov.35.IDs.gender.men70.women30.features)
      ...
      cov.35.IDs.gender.men70.women30.features <- c(cov.35.IDs.gender.men70.women30.features, 
                                                    cov.35.gender.men70.women30.ratio.seq,
                                                    cov.35.gender.men70.women30.ratio.emp)
      
      # cov.35.gender.men70.women30
    }else{
      cov.35.IDs.gender.men70.women30.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.35.IDs.gender.men70.women30.features)
