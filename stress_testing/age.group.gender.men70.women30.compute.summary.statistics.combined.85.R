...
age.group.gender.men70.women30.compute.summary.statistics.combined.85 <- function(datalist = datalist.agemix,
                                                                                  work.dir = work.dir,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.85.IDs.gender.men70.women30.age.group)>=cut.val){
      ...
      # 
      cov.85.IDs.gender.men70.women30.age.group.features <- as.numeric(cov.85.IDs.gender.men70.women30.age.group.features)
      ...
      cov.85.IDs.gender.men70.women30.age.group.features <- c(cov.85.IDs.gender.men70.women30.age.group.features,
                                                              cov.85.gender.men70.women30.age.group.ratio.seq,
                                                              cov.85.gender.men70.women30.age.group.ratio.emp)
      
    }else{
      cov.85.IDs.gender.men70.women30.age.group.features <- rep(NA, 8)
    }
