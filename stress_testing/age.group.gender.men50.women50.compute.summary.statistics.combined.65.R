...
age.group.gender.men50.women50.compute.summary.statistics.combined.65 <- function(datalist = datalist.agemix,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.65.IDs.gender.men50.women50)>=cut.val){
      ...
      cov.65.IDs.gender.men50.women50.features <- as.numeric(cov.65.IDs.gender.men50.women50.features)
      ...
      cov.65.IDs.gender.men50.women50.features <- c(cov.65.IDs.gender.men50.women50.features, 
                                                    cov.65.gender.men50.women50.ratio.seq,
                                                    cov.65.gender.men50.women50.ratio.emp)
      
      # cov.65.gender.men50.women50
    }else{
      cov.65.IDs.gender.men50.women50.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.65.IDs.gender.men50.women50.features)
