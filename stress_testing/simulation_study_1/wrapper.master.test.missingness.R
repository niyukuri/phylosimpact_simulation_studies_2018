...
wrapper.master.phylo.simpact.study.1 <- function(inputvector = input.vector){
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    mAr.cov.35.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 35,
    ...
    if(length(mAr.cov.35.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.35.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.35.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.35.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.35.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.35.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.35.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.35.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.35.IDs,
                                                                           tree.calib.LTT = mAr.cov.35.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.35.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.35.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.35.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.35.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.40.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 40,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.40.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.40.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.40.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.40.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.40.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.40.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.40.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.40.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.40.IDs,
                                                                           tree.calib.LTT = mAr.cov.40.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.40.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.40.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.40.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.40.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.45.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 45,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.45.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.45.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.45.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.45.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.45.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.45.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.45.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.45.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.45.IDs,
                                                                           tree.calib.LTT = mAr.cov.45.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.45.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.45.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.45.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.45.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.50.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 50,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.50.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.50.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.50.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.50.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.50.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.50.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.50.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.50.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.50.IDs,
                                                                           tree.calib.LTT = mAr.cov.50.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.50.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.50.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.50.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.50.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.55.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 55,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.55.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.55.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.55.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.55.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.55.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.55.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.55.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.55.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.55.IDs,
                                                                           tree.calib.LTT = mAr.cov.55.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.55.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.55.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.55.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.55.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.60.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 60,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.60.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.60.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.60.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.60.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.60.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.60.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.60.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.60.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.60.IDs,
                                                                           tree.calib.LTT = mAr.cov.60.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.60.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.60.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.60.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.60.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.65.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 65,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.65.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.65.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.65.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.65.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.65.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.65.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.65.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.65.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.65.IDs,
                                                                           tree.calib.LTT = mAr.cov.65.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.65.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.65.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.65.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.65.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.70.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 70,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.70.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.70.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.70.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.70.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.70.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.70.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.70.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.70.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.70.IDs,
                                                                           tree.calib.LTT = mAr.cov.70.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.70.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.70.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.70.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.70.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.75.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 75,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.75.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.75.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.75.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.75.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.75.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.75.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.75.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.75.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.75.IDs,
                                                                           tree.calib.LTT = mAr.cov.75.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.75.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.75.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.75.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.75.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.80.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 80,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.80.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.80.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.80.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.80.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.80.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.80.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.80.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.80.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.80.IDs,
                                                                           tree.calib.LTT = mAr.cov.80.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.80.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.80.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.80.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.80.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.85.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 85,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.85.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.85.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.85.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.85.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.85.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.85.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.85.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.85.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.85.IDs,
                                                                           tree.calib.LTT = mAr.cov.85.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.85.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.85.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.85.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.85.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.90.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 90,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.90.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.90.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.90.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.90.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.90.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.90.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.90.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.90.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.90.IDs,
                                                                           tree.calib.LTT = mAr.cov.90.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.90.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.90.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.90.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.90.IDs.features.phylogenetic))
    }
    ...
    mAr.cov.95.IDs <- IDs.Seq.Age.Groups(simpact.trans.net = simpact.trans.net,
                                         limitTransmEvents = 7,
                                         timewindow = c(10,40),
                                         seq.cov = 95,
                                         seq.gender.ratio = 0.7, # within same age group women have 70% of being sampled & men have only 30% 
    ...
    if(length(mAr.cov.95.IDs)>=cut.val){
      
      choose.sequence.ind(pool.seq.file = paste0(sub.dir.rename,"/C.Epidemic.fas"),
                          select.vec = mAr.cov.95.IDs, 
                          name.file = paste0(sub.dir.rename, "/mAr.cov.95.IDs.C.Epidemic.Fasta"))
      
      
      mAr.cov.95.IDs.tree.calib <- phylogenetic.tree.fasttree.par(dir.tree = dirfasttree,
                                                                  sub.dir.rename = sub.dir.rename,
                                                                  fasttree.tool = "FastTree",
                                                                  calendar.dates = "samplingtimes.all.csv",
                                                                  simseqfile = "mAr.cov.95.IDs.C.Epidemic.Fasta",
                                                                  count.start = 1977,
                                                                  endsim = 40,
                                                                  clust = FALSE)
      
      tree.cal.mAr.cov.95.IDs <- read.tree(paste0(sub.dir.rename, "/mAr.cov.95.IDs.C.Epidemic.Fasta.nwk"))
      
      mAr.cov.95.IDs.features.phylogenetic <- phylogenetic.features.study1(tree.topo=tree.cal.mAr.cov.95.IDs,
                                                                           tree.calib.LTT = mAr.cov.95.IDs.tree.calib,
                                                                           work.dir = work.dir,
                                                                           sub.dir.rename = sub.dir.rename,
                                                                           simpact.trans.net = simpact.trans.net,
                                                                           fasta.file = "mAr.cov.95.IDs.C.Epidemic.Fasta",
                                                                           tree.file = "mAr.cov.95.IDs.C.Epidemic.Fasta.nwk")
      
    }else{
      
      mAr.cov.95.IDs.features.phylogenetic <- rep(NA, length(mAr.cov.95.IDs.features.phylogenetic))
    }
    ...
    mAr.sim.features.phylogenetic <- c(mAr.cov.35.IDs.features.phylogenetic,
                                       ...
                                       mAr.cov.50.IDs.features.phylogenetic,
                                       mAr.cov.55.IDs.features.phylogenetic,
                                       mAr.cov.60.IDs.features.phylogenetic,
                                       mAr.cov.65.IDs.features.phylogenetic,
                                       mAr.cov.70.IDs.features.phylogenetic,
                                       mAr.cov.75.IDs.features.phylogenetic,
                                       mAr.cov.80.IDs.features.phylogenetic,
                                       mAr.cov.85.IDs.features.phylogenetic,
                                       mAr.cov.95.IDs.features.phylogenetic,
                                       mAr.cov.95.IDs.features.phylogenetic)
    
    name.mAr.cov.35.IDs.features.phylogenetic <- paste0("mAr.cov.35.",names(mAr.cov.35.IDs.features.phylogenetic))
    name.mAr.cov.40.IDs.features.phylogenetic <- paste0("mAr.cov.40.",names(mAr.cov.40.IDs.features.phylogenetic))
    name.mAr.cov.45.IDs.features.phylogenetic <- paste0("mAr.cov.45.",names(mAr.cov.45.IDs.features.phylogenetic))
    name.mAr.cov.50.IDs.features.phylogenetic <- paste0("mAr.cov.50.",names(mAr.cov.50.IDs.features.phylogenetic))
    name.mAr.cov.55.IDs.features.phylogenetic <- paste0("mAr.cov.55.",names(mAr.cov.55.IDs.features.phylogenetic))
    name.mAr.cov.60.IDs.features.phylogenetic <- paste0("mAr.cov.60.",names(mAr.cov.60.IDs.features.phylogenetic))
    name.mAr.cov.65.IDs.features.phylogenetic <- paste0("mAr.cov.65.",names(mAr.cov.65.IDs.features.phylogenetic))
    name.mAr.cov.70.IDs.features.phylogenetic <- paste0("mAr.cov.70.",names(mAr.cov.70.IDs.features.phylogenetic))
    name.mAr.cov.75.IDs.features.phylogenetic <- paste0("mAr.cov.75.",names(mAr.cov.75.IDs.features.phylogenetic))
    name.mAr.cov.80.IDs.features.phylogenetic <- paste0("mAr.cov.80.",names(mAr.cov.80.IDs.features.phylogenetic))
    name.mAr.cov.85.IDs.features.phylogenetic <- paste0("mAr.cov.85.",names(mAr.cov.85.IDs.features.phylogenetic))
    name.mAr.cov.90.IDs.features.phylogenetic <- paste0("mAr.cov.90.",names(mAr.cov.90.IDs.features.phylogenetic))
    name.mAr.cov.95.IDs.features.phylogenetic <- paste0("mAr.cov.95.",names(mAr.cov.95.IDs.features.phylogenetic))
    
    mAr.name.sim.features.phylogenetic <- c(name.mAr.cov.35.IDs.features.phylogenetic,
                                            name.mAr.cov.40.IDs.features.phylogenetic,
                                            name.mAr.cov.45.IDs.features.phylogenetic,
                                            name.mAr.cov.50.IDs.features.phylogenetic,
                                            name.mAr.cov.55.IDs.features.phylogenetic,
                                            name.mAr.cov.60.IDs.features.phylogenetic,
                                            name.mAr.cov.65.IDs.features.phylogenetic,
                                            name.mAr.cov.70.IDs.features.phylogenetic,
                                            name.mAr.cov.75.IDs.features.phylogenetic,
                                            name.mAr.cov.80.IDs.features.phylogenetic,
                                            name.mAr.cov.85.IDs.features.phylogenetic,
                                            name.mAr.cov.90.IDs.features.phylogenetic,
                                            name.mAr.cov.95.IDs.features.phylogenetic)
