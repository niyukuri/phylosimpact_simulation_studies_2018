...
simpact4ABC.classic.phylo.MCAR.mAr.cov.35 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.35 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.35) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.35)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.35,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.35,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.35,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.35, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.40 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.40 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.40) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.40)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.40,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.40,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.40,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.40, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.45 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.45 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.45) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.45)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.45,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.45,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.45,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.45, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.50 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.50 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.50) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.50)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.50,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.50,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.50,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.50, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.55 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.55 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.55) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.55)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.55,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.55,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.55,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.55, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.60 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.60 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.60) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.60)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.60,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.60,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.60,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.60, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.65 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.65 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.65) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.65)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.65,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.65,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.65,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.65, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.70 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.70 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.70) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.70)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.70,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.70,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.70,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.70, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.75 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.75 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.75) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.75)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.75,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.75,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.75,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.75, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.80 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.80 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.80) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.80)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.80,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.80,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.80,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.80, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.85 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.85 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.85) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.85)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.85,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.85,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.85,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.85, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.90 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.90 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.90) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.90)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.90,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.90,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.90,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.90, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.95 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.95 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.95) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.95)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.95,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.95,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.95,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.95, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.35 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.35 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.35) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.35)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.35,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.35,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.35,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.35, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.40 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.40 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.40) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.40)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.40,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.40,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.40,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.40, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.45 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.45 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.45) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.45)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.45,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.45,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.45,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.45, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.50 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.50 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.50) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.50)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.50,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.50,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.50,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.50, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.55 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.55 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.55) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.55)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.55,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.55,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.55,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.55, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.60 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.60 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.60) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.60)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.60,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.60,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.60,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.60, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.65 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.65 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.65) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.65)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.65,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.65,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.65,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.65, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.70 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.70 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.70) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.70)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.70,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.70,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.70,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.70, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.75 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.75 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.75) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.75)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.75,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.75,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.75,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.75, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.80 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.80 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.80) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.80)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.80,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.80,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.80,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.80, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.85 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.85 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.85) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.85)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.85,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.85,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.85,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.85, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.90 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.90 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.90) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.90)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.90,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.90,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.90,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.90, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.B.95 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.95 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.95) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.95)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.95,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.95,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.95,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.B.95, "/calibrated.tree.nwk"))
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.35 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.35 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.35) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.35)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.35,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.35,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.35,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.35, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.35) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.40 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.40 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.40) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.40)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.40,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.40,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.40,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.40, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.40) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.45 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.45 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.45) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.45)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.45,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.45,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.45,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.45, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.45) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.50 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.50 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.50) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.50)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.50,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.50,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.50,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.50, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.50) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.55 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.55 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.55) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.55)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.55,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.55,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.55,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.55, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.55) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.60 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.60 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.60) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.60)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.60,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.60,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.60,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.60, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.60) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.65 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.65 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.65) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.65)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.65,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.65,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.65,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.65, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.65) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.70 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.70 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.70) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.70)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.70,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.70,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.70,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.70, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.70) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.75 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.75 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.75) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.75)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.75,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.75,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.75,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.75, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.75) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.80 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.80 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.80) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.80)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.80,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.80,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.80,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.80, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.80) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.85 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.85 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.85) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.85)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.85,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.85,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.85,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.85, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.85) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.90 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.90 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.90) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.90)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.90,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.90,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.90,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.90, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.90) =30
...
simpact4ABC.classic.phylo.MCAR.mAr.cov.C.95 <- function(inputvector){
  ...
  ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.95 <- paste0(work.dir,"/temp/",generate.filename(10))
  ...
  results <- simpact.run(cfg, ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.95) #simpact.run(cfg, ABC_DestDir, identifierFormat = ABC_identifier)  
  ...
  classic.stat <- classic.features.study.1(datalist = datalist,
                                           work.dir = work.dir,
                                           sub.dir.rename = ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.95)
  ...
  if(!is.null(agemix.transm.df) == TRUE){
    ...
    # Transform the sequence format to be handled by ClusterPicker
    sequ.dna <- read.dna(file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.95,"/C.Epidemic_seed.seq.bis.sim.nwk.fasta"), format = "interleaved")
    write.dna(sequ.dna, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.95,"/C.Epidemic.fas") , format = "fasta")
    ...
    write.tree(tree.calib, file = paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.95,"/calibrated.tree.nwk"))
    ...
    tree.cal <- read.tree(paste0(ABC_DestDir.classic.phylo.MCAR.mAr.cov.C.95, "/calibrated.tree.nwk"))
    ...
    phlyo.stat <- rep(NA,30) # length(phylo.target.mAr.cov.C.95) =30
...
phylo.target.MCAR.cov.60 <-  colMedians(targets.stat[,177:206])
...
phylo.target.mAr.cov.C.35 <-  colMedians(targets.stat[,1197:1226])

phylo.target.mAr.cov.C.40 <-  colMedians(targets.stat[,1227:1256])

phylo.target.mAr.cov.C.45 <-  colMedians(targets.stat[,1257:1286])

phylo.target.mAr.cov.C.50 <-  colMedians(targets.stat[,1287:1316])

phylo.target.mAr.cov.C.55 <-  colMedians(targets.stat[,1317:1346])

phylo.target.mAr.cov.C.60 <-  colMedians(targets.stat[,1347:1376])

phylo.target.mAr.cov.C.65 <-  colMedians(targets.stat[,1377:1406])

phylo.target.mAr.cov.C.70 <-  colMedians(targets.stat[,1407:1436])

phylo.target.mAr.cov.C.75 <-  colMedians(targets.stat[,1437:1466])

phylo.target.mAr.cov.C.80 <-  colMedians(targets.stat[,1467:1496])

phylo.target.mAr.cov.C.85 <-  colMedians(targets.stat[,1497:1526])

phylo.target.mAr.cov.C.90 <-  colMedians(targets.stat[,1527:1556])

phylo.target.mAr.cov.C.95 <-  colMedians(targets.stat[,1557:1586])
