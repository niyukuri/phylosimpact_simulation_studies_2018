...
age.group.gender.men50.women50.compute.summary.statistics.combined.55 <- function(datalist = datalist.agemix,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.55.IDs.gender.men50.women50)>=cut.val){
      ...
      cov.55.IDs.gender.men50.women50.features <- as.numeric(cov.55.IDs.gender.men50.women50.features)
      ...
      cov.55.IDs.gender.men50.women50.features <- c(cov.55.IDs.gender.men50.women50.features, 
                                                    cov.55.gender.men50.women50.ratio.seq,
                                                    cov.55.gender.men50.women50.ratio.emp)
      
      # cov.55.gender.men50.women50
    }else{
      cov.55.IDs.gender.men50.women50.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.55.IDs.gender.men50.women50.features)
