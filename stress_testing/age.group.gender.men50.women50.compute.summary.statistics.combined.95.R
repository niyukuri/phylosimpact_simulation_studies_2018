...
age.group.gender.men50.women50.compute.summary.statistics.combined.95 <- function(datalist = datalist.agemix,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.95.IDs.gender.men50.women50)>=cut.val){
      ...
      cov.95.IDs.gender.men50.women50.features <- as.numeric(cov.95.IDs.gender.men50.women50.features)
      ...
      cov.95.IDs.gender.men50.women50.features <- c(cov.95.IDs.gender.men50.women50.features, 
                                                    cov.95.gender.men50.women50.ratio.seq,
                                                    cov.95.gender.men50.women50.ratio.emp)
      
      # cov.95.gender.men50.women50
    }else{
      cov.95.IDs.gender.men50.women50.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.95.IDs.gender.men50.women50.features)
