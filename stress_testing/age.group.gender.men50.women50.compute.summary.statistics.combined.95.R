...
age.group.gender.men50.women50.compute.summary.statistics.combined.95 <- function(datalist = datalist.agemix,
                                                                                  work.dir = work.dir,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.95.IDs.gender.men50.women50.age.group)>=cut.val){
      ...
      # 
      cov.95.IDs.gender.men50.women50.age.group.features <- as.numeric(cov.95.IDs.gender.men50.women50.age.group.features)
      ...
      cov.95.IDs.gender.men50.women50.age.group.features <- c(cov.95.IDs.gender.men50.women50.age.group.features,
                                                              cov.95.gender.men50.women50.age.group.ratio.seq,
                                                              cov.95.gender.men50.women50.age.group.ratio.emp)
      
    }else{
      cov.95.IDs.gender.men50.women50.age.group.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.95.IDs.gender.men50.women50.age.group.features)
