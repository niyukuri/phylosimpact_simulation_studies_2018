...
age.group.gender.men30.women70.compute.summary.statistics.combined.65 <- function(datalist = datalist.agemix,
                                                                                  work.dir = work.dir,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.65.IDs.gender.men30.women70.age.group)>=cut.val){
      ...
      # 
      cov.65.IDs.gender.men30.women70.age.group.features <- as.numeric(cov.65.IDs.gender.men30.women70.age.group.features)
      ...
      cov.65.IDs.gender.men30.women70.age.group.features <- c(cov.65.IDs.gender.men30.women70.age.group.features,
                                                              cov.65.gender.men30.women70.age.group.ratio.seq,
                                                              cov.65.gender.men30.women70.age.group.ratio.emp)
      
    }else{
      cov.65.IDs.gender.men30.women70.age.group.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.65.IDs.gender.men30.women70.age.group.features)
