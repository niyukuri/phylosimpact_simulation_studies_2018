...
setwd("/home/david/Dropbox/Stress_Testing/")
...
incidence.df.15.24 <- incidence.calculator(datalist = datalist,
                                           agegroup = c(15, 25), timewindow = c(10, 40))


incidence.df.25.34 <- incidence.calculator(datalist = datalist,
                                           agegroup = c(25, 35), timewindow = c(10, 40))


incidence.df.35.44 <- incidence.calculator(datalist = datalist,
...
source("/home/david/Dropbox/Stress_Testing/transmNetworkBuilder.diff2.R")


# Function of age mixing data: agemixing.trans.df
...
# Due to much computation time of transNetBuilder4() we put it external to age-mixing function
