...
gender.men30.women70.compute.summary.statistics.combined.85 <- function(datalist = datalist.agemix,
                                                                        work.dir = work.dir,
  ...
  if(file.exists(paste0(sub.dir.rename, "/C.Epidemic_seed.seq.bis.sim.nwk.fasta"))==TRUE){
    ...
    if(length(cov.85.IDs.gender.men30.women70)>=cut.val){
      ...
      cov.85.IDs.gender.men30.women70.features <- as.numeric(cov.85.IDs.gender.men30.women70.features)
      ...
      cov.85.IDs.gender.men30.women70.features <- c(cov.85.IDs.gender.men30.women70.features, 
                                                    cov.85.gender.men30.women70.ratio.seq,
                                                    cov.85.gender.men30.women70.ratio.emp)
      
      # cov.85.gender.men30.women70
    }else{
      cov.85.IDs.gender.men30.women70.features <- rep(NA, 8)
    }
    ...
    summary.df <- c(growthrate, 
                    ...
                    as.numeric(cov.85.IDs.gender.men30.women70.features)
