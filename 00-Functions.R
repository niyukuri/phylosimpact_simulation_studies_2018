...
# destDir <- "/user/data/gent/vsc400/vsc40070/phylo/temp" #paste0(root.path, "/temp")
...
#                                  population.nummen = 2500, #2500,
#                                  population.numwomen = 2500, #2500,
#                                  hivseed.time = 10,
#                                  hivseed.type = "amount",
...
# cfg.list["person.art.accept.threshold.dist.fixed.value"] <- 0.5
...
# art.intro5["person.art.accept.threshold.dist.fixed.value"] <- 0.75 # inputvector[8] ########### 0.75
# 
